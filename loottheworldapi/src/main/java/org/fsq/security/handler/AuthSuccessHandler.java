package org.fsq.security.handler;
...
import org.fsq.security.util.CookieUtils;
...
public class AuthSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    AuthSuccessHandler(TokenProvider tokenProvider, AppProperties appProperties,
                                       CookieAuthRequestRepository cookieAuthRequestRepository) {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request, CookieAuthRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
